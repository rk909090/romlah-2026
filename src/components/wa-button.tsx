 ...
 * penantian asinkron.
 *
 * PANELNYA DIRENDER KE <body> LEWAT PORTAL, bukan di tempat tombolnya. Dua
 * pemanggilnya — bilah tab bawah dan menu geser di header — hidup di dalam
 * elemen ber-`backdrop-filter`, dan elemen semacam itu menjadi acuan posisi
 * bagi anak `position: fixed`-nya. Tanpa portal, panelnya terkurung di dalam
 * bilah setinggi 60 piksel dan latar gelapnya tidak menutupi apa pun.
 */
...
const kelasLabel =
  "block text-xs font-semibold tracking-wide text-muted uppercase";
            ...
            >
              {tautan ? (
                <div className="text-center">
                  ...
                  <h2
                    id="judul-wa"
                    className="font-display mt-4 text-xl font-extrabold"
                  >
                    Data tersimpan
                  </h2>
                  <p className="mx-auto mt-2 max-w-xs text-sm leading-relaxed text-ink-2">
                    Pesannya sudah kami siapkan. Tekan tombol di bawah untuk
                ...
                <form onSubmit={kirim}>
                  ...
                  <p className="mt-1.5 text-sm leading-relaxed text-ink-2">
                    Isi dulu sebentar biar kami tahu siapa yang bertanya dan
                    bisa balas lebih cepat.
                  </p>
                  ...
                  <div className="mt-5 space-y-3.5">
                    ...
                    <label className="block">
                      ...
                      <input
                        ...
                        value={telepon}
                        onChange={(e) =>
                          setTelepon(saringAngka(e.target.value))
                        }
                        placeholder="08…"
                        type="tel"
                        inputMode="numeric"
                  ...
                  <p className="mt-4 text-center text-[11px] leading-relaxed text-muted">
                    Data ini kami simpan untuk membalas pertanyaan Anda dan
                    mengabari penawaran Romlah. Tidak dibagikan ke pihak lain.
                  </p>
                </form>
              )}
            </div>
